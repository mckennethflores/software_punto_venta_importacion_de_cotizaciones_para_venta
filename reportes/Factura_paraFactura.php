...
function addSociete( $nom, $adresse,$logo,$ext_logo )
{
	...
	$this->Image($logo , $xImg,$yImg, 0 , 0 , $ext_logo);
	//$this->Image($logo , 3 ,2, 40 , 25 , $ext_logo);
	$this->SetXY( $x1+2, $y1 );
...
// Client address
function addClientAdresse( $cliente,$domicilio,$num_documento,$email,$telefono,$fecha,$tipomoneda,$contacto )
{
	$border = 0;
	$r1     = $this->w - 200;
	$r2     = $r1 + 68;
...
/* 	$this->MultiCell( 60, 4, "CLIENTE"); */
	$this->Cell(22,5,'CLIENTE',$border,0,'C', false);
	$this->Cell(102,5,$cliente, $border, 0, 'L', false);
	$this->Cell(14,5, utf8_decode('RUC'),$border,0, 'C', false);
	$this->Cell(50,5, utf8_decode( $num_documento),$border,0, 'C', false);


	$this->SetFont( "Arial", "", 9);
	$this->Ln(5);
	$this->Cell(22, 5, utf8_decode('DIRECCIÓN:'), $border, 0, false);
	$this->Cell(166, 5,utf8_decode(strtoupper($domicilio)),$border, 0, false);

	$this->Ln(5);
$this->SetFont('arial','',9);
$this->Cell(17,5,'FECHA:',$border,0,'C', false);
$this->Cell(20,5,$fecha, $border, 0, 'L', false);
$this->Cell(17,5, utf8_decode('MONEDA:'),$border,0, 'C', false);
$this->SetFont('arial','B',9);
$this->Cell(18,5, utf8_decode('SOLES'),$border,0, 'R', false);
$this->SetFont('arial','',9);
$this->Cell(37,5, utf8_decode('CONDICIONES PAGO:'),$border,0, 'R', false);
$this->SetFont('arial','B',9);
$this->Cell(31,5, utf8_decode('CONTADO'),$border,0, 'L', false);
$this->SetFont('arial','',9);
$this->Cell(23,5, utf8_decode('TELÉFONOS:'),$border,0, 'L', false);
$this->Cell(25,5, utf8_decode($telefono),$border,0, 'L', false);



$this->Ln(5);
$this->SetFont('arial','B',9);
$this->Cell(35,5,'VENDEDOR:',$border,0,'C', false);
$this->Cell(65,5,$contacto, $border, 0, 'L', false);
$this->Cell(43,5, utf8_decode('OBSERVACIÓN'),$border,0, 'C', false);
$this->Cell(45,5, utf8_decode(''),$border,0, 'C', false);
...
function addCadreTVAs($monto,$bcpsoles,$bcpdolares,$cuentadetracciones)
{
	...
	$this->MultiCell(130,4, $monto);

		$this->RoundedRect(10, 257, 62, 20, 1, 'D');
		
		$this->SetFont( "Arial", "BI", 8);
		$this->SetXY( $r1+10, $y1+15);
		$this->MultiCell(100,4, "      ".NOMBRE_EMPRESA);
		$this->SetFont( "Arial", "", 8);
		$this->SetXY( $r1+0, $y1+18);
		$this->MultiCell(100,4+6, utf8_decode( "N° CTA CTE BCP SOLES: $bcpsoles"));
		$this->SetFont( "Arial", "", 8);
		...
		$this->SetXY( $r1+63, $y1+18);
		$this->MultiCell(100,4+5, utf8_decode( "              ¡GRACIAS POR SU PREFERENCIA!"));
		$this->SetFont( "Arial", "", 7);
		$this->SetXY( $r1+63, $y1+22);
		$this->MultiCell(100,4, utf8_decode( ""));
		/* $this->SetFont( "Arial", "", 8);
		$this->SetXY( $r1+0, $y1+32);
		$this->MultiCell(100,4, utf8_decode( "BANCO DE LA NACIÓN CTA CTE N° 00-059-078844"));
		 */
	//$this->SetX( $r1+29 );
