...
function addSociete( $nom, $adresse,$logo,$ext_logo )
{
	...
	$this->SetXY( $x1+$alignLeft, $y1 + $alignTop);
...
// Client address
function addClientAdresse( $cliente,$domicilio,$num_documento,$email,$telefono,$fecha,$tipomoneda,$contacto,$observacion)
{
	$r1     = $this->w - 200;
	$r2     = $r1 + 68;
	$y1     = 40;
...
/* 	$this->MultiCell( 60, 4, "CLIENTE"); */
	$this->Cell(22,5,'CLIENTE',1,0,'C', false);
	$this->Cell(102,5,$cliente, 1, 0, 'L', false);
	$this->Cell(14,5, utf8_decode('RUC'),1,0, 'C', false);
	$this->Cell(50,5, utf8_decode( $num_documento),1,0, 'R', false);


	$this->SetFont( "Arial", "", 9);
	$this->Ln(5);
	$this->Cell(22, 5, utf8_decode('DIRECCIÓN:'), 1, 0, false);
	$this->Cell(166, 5,utf8_decode(strtoupper($domicilio)),1, 0, false);

	$this->Ln(5);
$this->SetFont('arial','',9);
$this->Cell(17,5,'FECHA:',1,0,'C', false);
$this->Cell(20,5,$fecha, 1, 0, 'L', false);
$this->Cell(17,5, utf8_decode('MONEDA:'),1,0, 'C', false);
$this->Cell(18,5, utf8_decode($tipomoneda),1,0, 'R', false);
$this->Cell(37,5, utf8_decode('CONDICIONES PAGO:'),1,0, 'R', false);
$this->Cell(31,5, utf8_decode('CONTADO'),1,0, 'L', false);
$this->Cell(23,5, utf8_decode('TELÉFONOS:'),1,0, 'L', false);
$this->Cell(25,5, utf8_decode($telefono),1,0, 'L', false);



$this->Ln(5);
$this->SetFont('arial','',9);
$this->Cell(35,5,'VENDEDOR:',1,0,'C', false);
$this->Cell(65,5,'ALDO SANTINI'  , 1, 0, 'L', false);
$this->Cell(43 + 45,5, utf8_decode('OBSERVACIÓN'),1,0, 'C', false);
/* 
$this->Cell(45,5, utf8_decode(''),1,0, 'C', false); 
*/
...
function addCadreTVAs($nombre_empresa,$monto,$bcpsoles,$bcpdolares,$cuentadetracciones)
{
	...
	$this->MultiCell(130,4, $monto);
		...
		$this->SetXY( $r1+10, $y1+13);
		$this->MultiCell(100,4+3, $nombre_empresa);
