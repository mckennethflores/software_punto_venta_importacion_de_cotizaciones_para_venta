...
switch($_GET["op"]){
    ...
    case 'activar':
        ...
        echo $rspta ? "Venta Activada" : "Venta no se puedo Activar";
    break;
    ...
    case 'listarDetalle':
        ...
        <tfoot>
            ...
            <th></th>
            <th></th>
            <th><h4 id="total">S/ '. $total.'.00</h4> <input type="hidden" name="total_venta" id="total_venta"> </th>
        </tfoot>';
    break;
    case 'listar':
        $rspta=$venta->listar();
        ...
        while ($reg=$rspta->fetch_object()){
            ...
            $data[]=array(
                ...
                ' <a class="btn btn-info" target="_blank" href="'.$url.$reg->idventa.'"> Documento</a>',
                "1"=>$reg->fecha,
                "2"=>$reg->cliente,
                "3"=>$reg->usuario,
